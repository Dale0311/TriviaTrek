    ...
    <div className="text-white space-y-5 h-full flex flex-col">
      ...
      <div className="flex flex-col justify-between space-y-2 text-gray-700 bg-white h-full rounded-t-3xl p-4">
        ...
        <div className="space-y-12">
          ...
          <div>
            <button
              className="relative w-full inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-indigo-500 rounded-xl shadow-md group"
              onClick={() => {
